...
import burger from "./src/Images/burger_images.jpeg";
import biryani from "./src/Images/biryani_images.jpeg";
import pizza from "./src/Images/pizza_images.jpeg";
import roti from "./src/Images/roti_images.jpeg";
import pizza2 from "./src/Images/pizza2_images.jpeg";
...
const RestaurantCard = (props) => {
  // console.log(props);
  const { resObj } = props;
  const {cloudinaryImageId, areaName, cuisines, costForTwo, avgRating, sla:{deliveryTime}} = resObj?.info;

  return (
    <div className="res-card" style={styleCard}>
      <img className="burger_image" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId} alt="Image not Found" />
      <h3>{areaName}</h3>
      <h4>{cuisines.join(", ")}</h4>
      <h4>{costForTwo}</h4>
...
const restaurants= [
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2023-12-25 00:45:00",
        "opened": true
      },
      "badges": {
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2023-12-25 01:59:00",
        "opened": true
      },
      "badges": {
        "imageBadges": [
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2023-12-24 23:15:00",
        "opened": true
      },
      "badges": {
  ...
  },
  {
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/sunny-paji-da-dhaba-sadar-sarveshwar-chowk-rajkot-641515",
      "type": "WEBLINK"
    }
  },
  {
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2023-12-25 01:50:00",
        "opened": true
      },
      "badges": {
  ...
  },
  {
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/kwality-walls-frozen-dessert-and-ice-cream-shop-amin-marg-main-road-star-apartment-rajkot-748877",
      "type": "WEBLINK"
    }
  },
  {
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/ubq-by-barbeque-nation-crystal-mall-nana-mava-rajkot-105265",
      "type": "WEBLINK"
    }
  },
  {
  ...
  },
  {
    "info": {
      "id": "522992",
      "name": "Surti Egg Masti",
      "cloudinaryImageId": "94d6554cb324751dfe5b38a3bc4d152c",
      "locality": "Kalawad Road",
      "areaName": "kalawad road - Mota Mava",
      "costForTwo": "₹300 for two",
      "cuisines": [
        "Mughlai",
        "Biryani",
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/surti-egg-masti-kalawad-road-kalawad-road-mota-mava-rajkot-522992",
      "type": "WEBLINK"
    }
  },
  {
  ...
  },
  {
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/cheelizza-india-ka-pizza-jalaram-society-university-road-rajkot-444354",
      "type": "WEBLINK"
    }
  }
]
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        ...
        <RestaurantCard resObj={restaurants[3]} />
        <RestaurantCard resObj={restaurants[4]} />
        <RestaurantCard resObj={restaurants[5]} />
        <RestaurantCard resObj={restaurants[6]} />
        <RestaurantCard resObj={restaurants[7]} />
        <RestaurantCard resObj={restaurants[8]} />
        <RestaurantCard resObj={restaurants[9]} />
        <RestaurantCard resObj={restaurants[10]} /> */}
      </div>
    </div>
  );
};
